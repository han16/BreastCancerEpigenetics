...
path2="C:\\han\\Projects\\2025_03_breast_cancer\\Run_MAGMA_on_GWAS_HiC\\"
...
path3="C:\\han\\Projects\\2025_03_breast_cancer\\Run_MAGMA_on_GWAS_HiC\\peaks_in_paper\\"
hic <- read.table(paste0(path3, "GSM8138144_PT1_loops_q0.98_filt.txt"), header = T)
...
cat("Total mapped SNPs: ", nrow(snpcomb), "\n")  # it's supposed to be this number 10820451
...
```{r, message=F, warning=F, eval=F}
# run MAGMA
magma --bfile C:\\han\\Dataset\\20250221_PMID_32152537_hmagma\\g1000_eur\\g1000_eur --pval C:\\han\\Dataset\\20260326_TCGD\\Breast_Cancer_Clean_MAGMA.txt use=rsid, p.value N=139274 --gene-annot C:\\han\\Projects\\2025_03_breast_cancer\\Run_MAGMA_on_GWAS_HiC\\transcript.annot --out C:\\han\\Projects\\2025_03_breast_cancer\\Run_MAGMA_on_GWAS_HiC\\magma_output\\
